...
Search engine optimization based on Lighthouse SEO audits and Google Search guidelines. Focuses on technical SEO, on-page optimization, and structured data.
...
### LocalBusiness (for churches, local organizations)
